...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  5 02:29:45 2020
...
classifier = RandomForestClassifier(n_estimators=10,     # The number of trees in the forest.
                                    criterion='entropy', # The function to measure the quality of a split. 
                                                             #   entropy shows the disorder in particle of data
                                                             # higher entropy higher higher chance os mislead data
                                    random_state=0)      # To get same result
